      ...
      <div className="max-w-screen-2xl container  mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white dark:border">
        <div className="mt-28 items-center justify-center text-center ">
          ...
          <p className="text-black mt-12 ">
            ...
            cupiditate consequatur vero voluptates! Sint laboriosam, aut cum
            enim facilis amet dolorum beatae quas molestiae aliquid neque
            voluptates, provident cupiditate.
          </p>
          <Link to="/">
